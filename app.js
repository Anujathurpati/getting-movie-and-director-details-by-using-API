...
app.delete("/movies/:movieId/",async(response,response) =>{
    const {movieId} = request.params;
...
app.get("/directors/",async(request,response) =>{
    const getDirecotrsQuery = `
    SELECT * FROM director;`;
    const directorsArray = await database.all(getDirecotrsQuery);
 ...
 app.get("/directors/:directorId/movies/",async(request,response) =>{
     ...
     const moviesArray = await database.all(getDirectorMovies);
